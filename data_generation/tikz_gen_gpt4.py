...
ideaBotPrompt = "Generate one prompt for producing a creative TikZ diagram that depicts a free body diagram one might see in a physics textbook. Do not prompt the AI to produce labels or Latin characters."
